...

{
  ...
  coherent = pkgs.vimUtils.buildVimPlugin {
    ...
    src = pkgs.fetchFromGitHub {
      owner = "ivanbrennan";
      repo = "coherent";
      rev = "d4cde2c249baecd5637524fb24101c9902c85b20";
      sha256 = "1xbkz3lafd7i6vj9cf2r41zh582l3rwhfv164zfzx9n4qr127b1s";
    };
  };
  ...
  ftglue = pkgs.vimUtils.buildVimPlugin {
    ...
    src = pkgs.fetchFromGitHub {
      owner = "ivanbrennan";
      repo = "ftglue";
      rev = "0e8ae2db322b0d47b2b5b0e032348b0d7e65a97f";
      sha256 = "0pbhqqcknh6x76jx7clhsgwwib0wv24j04mm2n6ysdppkamqgdk6";
    };
  };
